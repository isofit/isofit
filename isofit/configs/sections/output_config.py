...
class OutputConfig(BaseConfigSection):
    ...
    def __init__(self, sub_configdic: dict = None):
        ...
        self._estimated_reflectance_file_header = ('wavelength','{Wavelength (nm), Lambertian Reflectance}','{0.0,1.0}')
        self._estimated_reflectance_file_type = str
        self.estimated_reflectance_file = None

        self._estimated_emission_file_header = ('wavelength','{Wavelength (nm), Emitted Radiance (uW nm-1 cm-2 sr-1)}','{}')
        self._estimated_emission_file_type = str
        self.estimated_emission_file = None

        self._modeled_radiance_file_header = ('wavelength','{Wavelength (nm), Modeled Radiance (uW nm-1 cm-2 sr-1)}','{}')
        self._modeled_radiance_file_type = str
        self.modeled_radiance_file = None

        self._apparent_reflectance_file_header = ('wavelength','{Wavelength (nm), Apparent Surface Reflectance}','{}')
        self._apparent_reflectance_file_type = str
        self.apparent_reflectance_file = None

        self._path_radiance_file_header = ('wavelength','{Wavelength (nm), Path Radiance (uW nm-1 cm-2 sr-1)}','{}')
        self._path_radiance_file_type = str
        self.path_radiance_file = None

        self._simulated_measurement_file_header = ('wavelength','{Wavelength (nm), Simulated Radiance (uW nm-1 cm-2 sr-1)}','{}')
        self._simulated_measurement_file_type = str
        self.simulated_measurement_file = None

        self._algebraic_inverse_file_header = ('wavelength','{Wavelength (nm), Apparent Surface Reflectance}','{}')
        self._algebraic_inverse_file_type = str
        self.algebraic_inverse_file = None

        self._atmospheric_coefficients_file_header = ('wavelength','{Wavelength (nm), Atmospheric Optical Parameters}','{}')
        self._atmospheric_coefficients_file_type = str
        self.atmospheric_coefficients_file = None

        self._radiometry_correction_file_header = ('wavelength', '{Wavelength (nm), Radiometric Correction Factors}', '{}')
