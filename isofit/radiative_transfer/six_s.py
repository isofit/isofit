...
from ..core.common import resample_spectrum, load_wavelen, VectorInterpolator
...
class SixSRT(TabularRT):
    ...
    def __init__(self, config, statevector_names):
        ...
        self.esd = np.loadtxt(config['earth_sun_distance_file'])
        ...
        irr = np.loadtxt(config['irradiance_file'], comments='#')
        iwl, irr = irr.T
