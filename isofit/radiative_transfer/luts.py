...
def load(
    ...
    **kwargs,
    ...
    v = ds.attrs.get("ISOFIT version", "<not set>")
    Logger.debug(
        f"This LUT was created with ISOFIT version {v}, you are running ISOFIT {version}"
    )
