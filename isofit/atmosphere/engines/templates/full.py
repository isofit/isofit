...
class CustomAtmosphere(BaseAtmosphere, Writer):
    ...
    def preSim(self):
        """
        Required to be defined. If not needed, be sure to define the function and simply ``pass``.
    ...
    def readSim(self, point: np.array):
        ...
        Where
            ...
            "rhoatm" is in luts.Keys.alldim, so it will be saved along dims ("wl", "point") at the index of this `point`
        """
        pass
