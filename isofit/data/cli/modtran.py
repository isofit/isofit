...
def download_cli(**kwargs):
    ...
    There are two ways to specify output directory:
        ...
        - `isofit download modtran --path /path/modtran`: Temporarily set the output location. This will not be saved in the ini and may need to be manually set.
...
def validate_cli(**kwargs):
    """\
    Validates the installation of MODTRAN
    """
    validate(**kwargs)
