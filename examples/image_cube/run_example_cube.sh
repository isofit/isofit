...
# Small test (10x10 pixels, no empirical line)
...
# Medium test (1000x598 pixels, empirical line)
python ${isofit_base_path}/utils/apply_oe.py medium_chunk/${file_base}_rdn_7k-8k medium_chunk/${file_base}_loc_7k-8k medium_chunk/${file_base}_obs_7k-8k medium_chunk_test ang --presolve=1 --empirical_line=1 --emulator_base=${EMULATOR_PATH} --n_cores ${n_cores} --surface_path configs/basic_surface.mat